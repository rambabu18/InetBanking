...
public class Report extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setDocumentTitle("IBanking Test Project");
		
		htmlReporter.config().setDocumentTitle("Functional Test Project");
	...
	public void onTestSuccess(ITestResult tr) {
		...
		String screenshotPath = System.getProperty("use.dir")+"\\ScreenShot\\"+tr.getName()+".png";
